...
Feature set available for query with mpg123\+\_\+feature. \begin{DoxyEnumFields}{枚举值}
...
\raisebox{\heightof{T}}[0pt][0pt]{\index{M\+P\+G123\+\_\+\+F\+E\+A\+T\+U\+R\+E\+\_\+\+E\+Q\+U\+A\+L\+I\+Z\+ER@{M\+P\+G123\+\_\+\+F\+E\+A\+T\+U\+R\+E\+\_\+\+E\+Q\+U\+A\+L\+I\+Z\+ER}!mpg123 library and handle setup@{mpg123 library and handle setup}}\index{mpg123 library and handle setup@{mpg123 library and handle setup}!M\+P\+G123\+\_\+\+F\+E\+A\+T\+U\+R\+E\+\_\+\+E\+Q\+U\+A\+L\+I\+Z\+ER@{M\+P\+G123\+\_\+\+F\+E\+A\+T\+U\+R\+E\+\_\+\+E\+Q\+U\+A\+L\+I\+Z\+ER}}}\mbox{\Hypertarget{group__mpg123__init_ggab26f1b8c3289847f5928176a20b4c942a6ca3ab6ce7b24b67ac0a213c0e29ca72}\label{group__mpg123__init_ggab26f1b8c3289847f5928176a20b4c942a6ca3ab6ce7b24b67ac0a213c0e29ca72}} 
...
\subsubsection{\texorpdfstring{mpg123\+\_\+param\+\_\+flags}{mpg123\_param\_flags}}
{\footnotesize\ttfamily \hyperlink{interfaceenum}{enum} \hyperlink{group__mpg123__init_ga12f1bf1105a9b0c1501b20516a9719d4}{mpg123\+\_\+param\+\_\+flags}}

Flag bits for M\+P\+G123\+\_\+\+F\+L\+A\+GS, use the usual binary or to combine. \begin{DoxyEnumFields}{枚举值}
...
M\+P\+G123\+\_\+\+F\+O\+R\+C\+E\+\_\+\+M\+O\+NO&0111 Force some mono mode\+: \hyperlink{namespace_this}{This} is a test bitmask for seeing if any mono forcing is active. \\
\hline
...
\raisebox{\heightof{T}}[0pt][0pt]{\index{M\+P\+G123\+\_\+\+N\+O\+\_\+\+P\+E\+E\+K\+\_\+\+E\+ND@{M\+P\+G123\+\_\+\+N\+O\+\_\+\+P\+E\+E\+K\+\_\+\+E\+ND}!mpg123 library and handle setup@{mpg123 library and handle setup}}\index{mpg123 library and handle setup@{mpg123 library and handle setup}!M\+P\+G123\+\_\+\+N\+O\+\_\+\+P\+E\+E\+K\+\_\+\+E\+ND@{M\+P\+G123\+\_\+\+N\+O\+\_\+\+P\+E\+E\+K\+\_\+\+E\+ND}}}\mbox{\Hypertarget{group__mpg123__init_gga12f1bf1105a9b0c1501b20516a9719d4a76ec6c65776981df0f83422a8db8b461}\label{group__mpg123__init_gga12f1bf1105a9b0c1501b20516a9719d4a76ec6c65776981df0f83422a8db8b461}} 
M\+P\+G123\+\_\+\+N\+O\+\_\+\+P\+E\+E\+K\+\_\+\+E\+ND&18th bit\+: Do not seek to the end of the stream in order to probe the stream length and search for the id3v1 field. \hyperlink{namespace_this}{This} also means the file size is unknown unless set using \hyperlink{group__mpg123__status_gad0301e80dbc3f48e47e27d39cd328755}{mpg123\+\_\+set\+\_\+filesize()} and the stream is assumed as non-\/seekable unless overridden. \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{M\+P\+G123\+\_\+\+F\+O\+R\+C\+E\+\_\+\+S\+E\+E\+K\+A\+B\+LE@{M\+P\+G123\+\_\+\+F\+O\+R\+C\+E\+\_\+\+S\+E\+E\+K\+A\+B\+LE}!mpg123 library and handle setup@{mpg123 library and handle setup}}\index{mpg123 library and handle setup@{mpg123 library and handle setup}!M\+P\+G123\+\_\+\+F\+O\+R\+C\+E\+\_\+\+S\+E\+E\+K\+A\+B\+LE@{M\+P\+G123\+\_\+\+F\+O\+R\+C\+E\+\_\+\+S\+E\+E\+K\+A\+B\+LE}}}\mbox{\Hypertarget{group__mpg123__init_gga12f1bf1105a9b0c1501b20516a9719d4a984d1fff70244c4203284bf0e7ae6976}\label{group__mpg123__init_gga12f1bf1105a9b0c1501b20516a9719d4a984d1fff70244c4203284bf0e7ae6976}} 
...
\subsubsection{\texorpdfstring{mpg123\+\_\+param\+\_\+rva}{mpg123\_param\_rva}}
{\footnotesize\ttfamily \hyperlink{interfaceenum}{enum} \hyperlink{group__mpg123__init_ga911d4cba9eb5e98b37e61ea2f05f5d16}{mpg123\+\_\+param\+\_\+rva}}

choices for M\+P\+G123\+\_\+\+R\+VA \begin{DoxyEnumFields}{枚举值}
...
\subsubsection{\texorpdfstring{mpg123\+\_\+parms}{mpg123\_parms}}
{\footnotesize\ttfamily \hyperlink{interfaceenum}{enum} \hyperlink{group__mpg123__init_ga73a8ff3363028b89afc72b3ea032b9cb}{mpg123\+\_\+parms}}

Enumeration of the parameters types that it is possible to set/get. \begin{DoxyEnumFields}{枚举值}
...
M\+P\+G123\+\_\+\+R\+E\+S\+Y\+N\+C\+\_\+\+L\+I\+M\+IT&Try resync on frame parsing for that many bytes or until end of stream ($<$0 ... integer). \hyperlink{namespace_this}{This} can enlarge the limit for skipping junk on beginning, too (but not reduce it). \\
\hline
...
M\+P\+G123\+\_\+\+P\+R\+E\+F\+R\+A\+M\+ES&Decode/ignore that many frames in advance for layer 3. \hyperlink{namespace_this}{This} is needed to fill bit reservoir after seeking, for example (but also at least one frame in advance is needed to have all \char`\"{}normal\char`\"{} data for layer 3). Give a positive integer value, please. \\
\hline
...
M\+P\+G123\+\_\+\+F\+E\+E\+D\+P\+O\+OL&For feeder mode, keep that many buffers in a pool to avoid frequent malloc/free. The pool is allocated on \hyperlink{group__mpg123__input_ga072669ae9bde29eea8cffa4be10c7345}{mpg123\+\_\+open\+\_\+feed()}. If you change this parameter afterwards, you can trigger growth and shrinkage during decoding. The default value could change any time. If you care about this, then set it. (integer) \\
\hline
...
{\footnotesize\ttfamily \hyperlink{mpg123_8h_a2ba98cfba3f760879df70e755b2a61cc}{M\+P\+G123\+\_\+\+E\+X\+P\+O\+RT} \hyperlink{interfacevoid}{void} mpg123\+\_\+delete (\begin{DoxyParamCaption}\item[{\hyperlink{group__mpg123__init_ga6728e2839a395f3a07d4514da659faca}{mpg123\+\_\+handle} $\ast$}]{mh }\end{DoxyParamCaption})}
...
Function to close down the mpg123 library. \hyperlink{namespace_this}{This} function is not thread-\/safe. Call it exactly once per process, before any other (possibly threaded) work with the library. \mbox{\Hypertarget{group__mpg123__init_gaf9b00e4fc7273c0d5e41d6d490606d56}\label{group__mpg123__init_gaf9b00e4fc7273c0d5e41d6d490606d56}} 
...
Function to initialise the mpg123 library. \hyperlink{namespace_this}{This} function is not thread-\/safe. Call it exactly once per process, before any other (possibly threaded) work with the library.
